...
# SCILAB_SOURCE_DIR: the source tree. machine.h and version.h are GENERATED by
# CMake at configure time into ${CMAKE_BINARY_DIR}/generated-includes/ — machine.h
# from cmake/machine.h.cmake.in (ScilabMachineHeader.cmake), version.h from
# modules/core/includes/version.h.in (ScilabConfigure.cmake) — and that dir is
# PREPENDED to the module include path, so the compile consumes the generated
# copies. A fresh clone therefore needs neither header on disk, only the two
# tracked templates; the old gitignored, configure-produced copies under
# modules/core/includes/ are legacy and no longer required (the consumption
# cutover, docs/design/deferred-fixes-register.md §5a2, is complete).
...
# Sanity-check SCILAB_SOURCE_DIR points at a real Scilab tree via a TRACKED file
# (the version.h template), so a fresh clone passes and a mis-set -D fails clearly.
if(NOT EXISTS "${SCILAB_SOURCE_DIR}/modules/core/includes/version.h.in")
  message(FATAL_ERROR
    "version.h.in not found under ${SCILAB_SOURCE_DIR}/modules/core/includes/ — "
    "SCILAB_SOURCE_DIR does not point at a Scilab source tree. Pass -DSCILAB_SOURCE_DIR=<tree>.")
endif()
